...
import { ADMIN_DELETE_POSTER, ADMIN_MOVE_DOWN_POSTER, ADMIN_MOVE_UP_POSTER, FAILED_ADMIN_POSTER_LOAD, START_ADMIN_POSTER_LOAD, SUCCESS_ADMIN_POSTER_LOAD } from "./adminPosterManageActions"
    ...
    switch(action.type){
        ...
        case ADMIN_DELETE_POSTER:
            ...
            return {
                ...state, 
                posters: [...n],
                delete: [...state.delete, state.posters.filter(el=>(el.id === action.payload))[0]]
            }
        default:
            return state
    }
