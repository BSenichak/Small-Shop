...
import { adminAddNewCategory, adminLoadCategories, adminUpdateCategories } from "../../../store/admin/adminCategoryManageActions";
...
export const AdminCAtegoriesManage = (props) => {
  ...
  return <div className={s.wrapper}>
    {props.categories.map(el=><AdminCategoryesItem key={el.id} data={el}/>)}
    <div className={s.btn} onClick={()=>props.save(props.categories, props.del)}>SAVE</div>
    <div className={s.adding}>
        ...
        props.add(props.categories.length, name, image, imageFile)
        setName("")
        setImage("")
        setImageUrl("")
        }}>ADD</div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    add: (id, name, imgLink, imgFile)=>dispatch(adminAddNewCategory(id, name, imgLink, imgFile)),
  };
};
